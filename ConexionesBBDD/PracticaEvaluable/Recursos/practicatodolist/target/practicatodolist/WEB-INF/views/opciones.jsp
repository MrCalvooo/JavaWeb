...
<html>
    ...
    <body>
         <div class="container">
            ...
            <h3><!--mensaje saludando al usuario SOLO cuando llego desde el login--></h3>
 
            <h2><!--enlace para volver a index.jsp-->Volver a la página de inicio</a></h2>
            ...
            <form action = "opcionesL" method = "post">
                ...
                <input type="hidden" id="usuario" name="usuario" readonly value=IDUSUARIO/>
